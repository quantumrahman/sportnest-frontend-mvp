...
export default function SigninPage() {
    ...
    return (
        <div className="flex min-h-screen w-full items-center justify-center bg-neutral-900">
            <div className="flex flex-2 flex-col items-center justify-center px-5 md:px-10">
                <div className="w-full max-w-[450px]">
                    ...
                    <div className="flex w-full flex-col items-center text-center">
                        ...
                        <p className="mt-2 w-full max-w-[400px] text-sm text-neutral-400">
                            Welcome back! Sign in to access your SportNest
                            account and manage your bookings.
                        </p>
                    </div>
                    <button
            ...
            <div
                className={`hidden min-h-screen flex-1 bg-[url('/img/auth.webp')] bg-cover bg-center bg-no-repeat md:block`}
            ></div>
        </div>
    );
}
